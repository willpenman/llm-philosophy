...
We can make this difference among models more quantitative by visualizing the differences among all supported models. Claude Opus 4.5 is in the top left, Kimi K2 is in the far left, and Gemini 2.0 Flash Lite (labeled "Flash Lite") is toward the bottom right.
