...
## Current status
Recently added: Rehearsals puzzle - [only one model got off the ground](https://willpenman.com/rehearsals-puzzle.html). Read LLMs' responses in the [compendium]((/responses/compendium.docx)).
...
We can make this difference among models more quantitative by visualizing the differences among all supported models, for all puzzles. Claude Opus 4.5 is toward the top, Kimi K2 is in the top right (by the legend), and Gemini 2.0 Flash Lite (labeled "Flash Lite") is down at the bottom.
